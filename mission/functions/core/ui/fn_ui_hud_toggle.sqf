...
if (_enabled) then {
    showHUD [
        true,    // Scripted HUD (same as showHUD command) -- NOTE: enables/disables scroll wheel menu
        ...
        false,   // Group Bar
        true,   // HUD Weapon Cursors -- NOTE: shows/hides scroll wheel menu, BUT also shows other UI elements
