...
class Land_vn_tent_mash_01_03
{
	...
	class build_states
	{
		class initial_state
		{
			object_class = "vn_tent_mash_01_03_part0";
		};
		class middle_state
		{
			object_class = "vn_tent_mash_01_03_part1";
		};
		class final_state
		{
			object_class = "Land_vn_tent_mash_01_03";
		};
	};
};

class Land_vn_tent_mash_02_04
{
	name = "STR_vn_mf_aid_post";
	type = "aid";
	categories[] = {"medical", "functional", "tents"};
	...
	class build_states
	{
		class initial_state
		{
			object_class = "vn_tent_mash_02_04_part0";
		};
		class middle_state
		{
			object_class = "vn_tent_mash_02_04_part1";
		};
		class final_state
		{
			object_class = "Land_vn_tent_mash_02_04";
		};
	};
};
